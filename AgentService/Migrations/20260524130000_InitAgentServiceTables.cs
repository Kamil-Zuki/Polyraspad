...
[DbContext(typeof(Data.AgentServiceContext))]
[Migration("20260524130000_InitAgentServiceTables")]
public partial class InitAgentServiceTables : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql("""
            ...
            CREATE TABLE IF NOT EXISTS internal.agent_artifacts (
                id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
                run_id uuid NOT NULL,
                thread_id uuid NOT NULL,
                ...
                created_at timestamp with time zone NOT NULL DEFAULT now(),
                CONSTRAINT fk_agent_artifacts_runs FOREIGN KEY (run_id)
                    REFERENCES internal.agent_runs (id) ON DELETE CASCADE,
                CONSTRAINT fk_agent_artifacts_threads FOREIGN KEY (thread_id)
                    REFERENCES internal.agent_threads (id) ON DELETE CASCADE
            );

            CREATE INDEX IF NOT EXISTS idx_agent_artifacts_thread_created
                ON internal.agent_artifacts (thread_id, created_at);
            """);
    }
    ...
    {
        migrationBuilder.Sql("""
            DROP TABLE IF EXISTS internal.agent_artifacts;
