...
Use only when `02-tdd-triage` classifies the next increment as new behavior.

If the task is a defect in existing behavior, route to `04-regression-tdd-bugfix`.
...
- Do not write production code before `06-tdd-red` proves a failing test.
