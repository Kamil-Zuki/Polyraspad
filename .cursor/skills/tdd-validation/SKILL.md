...
Use after `tdd-green`, `refactor-on-green`, integration verification, or docs checking.
...
- `pass` with more scope remaining -> `tdd-triage`
- `pass` with broader proof needed -> `tdd-integration-verifier` or `tdd-docs-contract-check`
- `fail` -> `tdd-failure-recovery`
