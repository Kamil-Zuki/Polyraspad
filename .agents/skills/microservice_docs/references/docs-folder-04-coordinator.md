...
| Подпапка | Rule file |
| :--- | :--- |
| `Методы API/DTO/` | `docs-folder-04-dto.mdc` |
| `Методы API/gRPC/` + `.proto` | `docs-folder-04-grpc.mdc` |
| `Методы API/REST API/` | `docs-folder-04-rest-api.mdc` |
| `Методы API/Socket/` | `docs-folder-04-socket.mdc` |
| `Интеграции со сторонними сервисами/` | `docs-folder-04-integrations.mdc` |
| `Работа с Rabbit MQ/` | `docs-folder-04-rabbitmq.mdc` |
| `Работа с Redis/` | `docs-folder-04-redis.mdc` |
| `Алгоритмы и методы бекенда/` | `docs-folder-04-algorithms.mdc` |
...
- `npx openskills read docs-04-coordinator`
