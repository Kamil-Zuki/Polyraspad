...
### Fixed (Исправлено)
- **Frontend Build (Docker):** Синхронизирован `package-lock.json` с добавлением отсутствовавшего пакета `@swc/helpers@0.5.23`, что устранило ошибку `npm ci` при сборке Docker-образа `polyraspad-frontend`.
