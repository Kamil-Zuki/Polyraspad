---
title: "Ревизия: пайплайн обучения (FSRS)"
tags: [polyraspad, docs, review, study, fsrs, srs]
date: 2026-03-18
---
...
|----|----------|----------|
| **SR-LRN-01** | Генерация очереди обучения (приоритеты: Lapses → Reviews → New, лимиты, иерархия колод) | [[Основные возможности]], [[Описание REST API]] |
| **SR-LRN-02** | Cloze Deletion (скрытие слова в контексте) | [[Основные возможности]] |
| **SR-LRN-03** | FSRS-расчёт интервалов (Stability, Difficulty, target retention) | [[Основные возможности]], [[Описание REST API]] |
| **SR-LRN-04** | Sibling Burying (не показывать одну лемму дважды в сессии) | [[Описание REST API]], [[Entities]] |
| **SR-LRN-05** | Обнаружение и обработка Leech-фраз (подвешивание после N lapses) | [[Основные возможности]], [[Описание REST API]] |
...
| **SR-LRN-08** | Undo (отмена последнего ответа, откат SRS и возврат карты в очередь) | [[Описание REST API]], [[DTO Description]] |
