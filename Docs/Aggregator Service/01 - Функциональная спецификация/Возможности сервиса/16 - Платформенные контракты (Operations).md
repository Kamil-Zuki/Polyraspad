...
*Все 16 групп 01 — Функциональная спецификация — описаны. Следующий этап по STEOS workflow: расширение `03 - Модель Данных` и детализация `04 - Бекенд, API и Контракты`.*
