...
| :---------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **SR-AGG-CONTENT-01** | **Управление языковыми проектами:** Create/Read/Update проектов (Delete в REST отсутствует); шлюз не хранит project локально. |
...
## SR-AGG-CONTENT-01: Управление проектами (без Delete) {#SR-AGG-CONTENT-01}
