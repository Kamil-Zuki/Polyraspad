Конечно. Я консолидировал все наши обсуждения, правки по навигации и требование по поддержке медиа (как в Anki) в единый документ **«Часть 1: Информационная Архитектура и Навигация»**.

Этот документ служит фундаментом перед тем, как мы начнем утверждать цвета и шрифты.
