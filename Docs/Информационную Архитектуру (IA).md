...
**Версия:** 2.0 (Updated)  
**Концепция:** «Leonardo.ai for Languages» — тёмный, иммерсивный интерфейс профессионального инструмента.
...
2. **/profile (Global Settings)** — Настройки аккаунта, биллинг, смена пароля.
