---
name: docs-04-verify
description: Readonly audit of microservice folder 04 against 01/03/02 — consistency checks, ISSUE files in 99-Staging. Use after 04 writes, before marking 04 complete, or @docs-04-verifier.
---

# Microservice Docs — 04 Verifier
...
- `<Service>/01`, `03`, `02`
- Rules consistency list: `.cursor/rules/docs-folder-04-coordinator.mdc` → Consistency Checks

## Workflow

1. Run [checklist.md](checklist.md) section by section.
2. For each failure → create or update ISSUE using [issue-template.md](issue-template.md) and [docs-staging-issues.mdc](../../rules/docs-staging-issues.mdc).
