...
**Канонический стиль и структура body:** [`.cursor/rules/steos-docs-staging-issues.mdc`](../../rules/steos-docs-staging-issues.mdc) — язык для человека, якорь **SR-ID** / **Entity.field** / **RPC**, путь к файлу вторичен.

## Расхождение `01` ↔ `03`

Сверка и типы: [`.cursor/rules/steos-docs-staging-0103.mdc`](../../rules/steos-docs-staging-0103.mdc)
...
Body — по [`steos-docs-staging-issues.mdc`](../../rules/steos-docs-staging-issues.mdc). В **«Где проблема»** указывай:
