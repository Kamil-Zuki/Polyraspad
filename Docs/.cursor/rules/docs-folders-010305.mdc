...
См. **`.cursor/rules/docs-staging-0103.mdc`** — сверка с парной папкой и **запись ISSUE на диск** обязательны при конфликте.
...
1. **Write** ISSUE + update реестр (`docs-staging-0103.mdc`, стиль — `docs-staging-issues.mdc`).
