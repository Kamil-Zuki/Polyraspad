...
- STEOS-документация (`Docs/<Service>/`) управляется правилами `Docs/.cursor/rules/`. Не редактируйте `03` (модель данных) без явного запроса.
...
- `Docs/.cursor/rules/steos-docs-core.mdc` — правила документирования сервисов.
